...
# Run FastAPI app with 2 worker processes for true parallelism around the
# Python GIL (CPU-bound YOLO inference cannot be parallelised within one
# Python process). Each worker loads its own model copy.
